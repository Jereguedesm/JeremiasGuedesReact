...
const AboutPage = () => {
  ...
  return (
    <main className='main'>
        <div>
        {t('main.aboutMePage.introduction')
          .split('\n')
          .map((paragraph, index) => (
...
/*<div>
        <p>Hola, me presento, mi nombre completo es Jeremías Nicolás Guedes Mendes, soy de Bueno Aires, Argentina, o como a mí me gusta decirle, la civilización austral (guiño a Santi Siri).\n</p>
        <p>
